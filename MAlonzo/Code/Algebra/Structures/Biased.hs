...
data T_IsCommutativeMonoid'691'_2716
  = C_IsCommutativeMonoid'691''46'constructor_36335 MAlonzo.Code.Algebra.Structures.T_IsSemigroup_472
                                                    (AgdaAny -> AgdaAny)
                                                    (AgdaAny -> AgdaAny -> AgdaAny)
...
d_isSemigroup_2728 v0
  = case coe v0 of
      C_IsCommutativeMonoid'691''46'constructor_36335 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_identity'691'_2730 v0
  = case coe v0 of
      C_IsCommutativeMonoid'691''46'constructor_36335 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_comm_2732 v0
  = case coe v0 of
      C_IsCommutativeMonoid'691''46'constructor_36335 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsSemiringWithoutOne'42'_2772
  = C_IsSemiringWithoutOne'42''46'constructor_37809 MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_736
                                                    MAlonzo.Code.Algebra.Structures.T_IsSemigroup_472
...
d_'43''45'isCommutativeMonoid_2788 v0
  = case coe v0 of
      C_IsSemiringWithoutOne'42''46'constructor_37809 v1 v2 v3 v4
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsNearSemiring'42'_2834
  = C_IsNearSemiring'42''46'constructor_39611 MAlonzo.Code.Algebra.Structures.T_IsMonoid_686
                                              MAlonzo.Code.Algebra.Structures.T_IsSemigroup_472
                                              (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                              (AgdaAny -> AgdaAny)
...
d_'43''45'isMonoid_2850 v0
  = case coe v0 of
      C_IsNearSemiring'42''46'constructor_39611 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_'42''45'isSemigroup_2852 v0
  = case coe v0 of
      C_IsNearSemiring'42''46'constructor_39611 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_distrib'691'_2854 v0
  = case coe v0 of
      C_IsNearSemiring'42''46'constructor_39611 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Structures.Biased.IsNearSemiring*.zeroˡ
d_zero'737'_2856 :: T_IsNearSemiring'42'_2834 -> AgdaAny -> AgdaAny
d_zero'737'_2856 v0
  = case coe v0 of
      C_IsNearSemiring'42''46'constructor_39611 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_isNearSemiring_2858 v0
  = coe
      MAlonzo.Code.Algebra.Structures.C_IsNearSemiring'46'constructor_34973
...
data T_IsSemiringWithoutAnnihilatingZero'42'_2898
  = C_IsSemiringWithoutAnnihilatingZero'42''46'constructor_41407 MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_736
                                                                 MAlonzo.Code.Algebra.Structures.T_IsMonoid_686
                                                                 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_'43''45'isCommutativeMonoid_2914 v0
  = case coe v0 of
      C_IsSemiringWithoutAnnihilatingZero'42''46'constructor_41407 v1 v2 v3
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsCommutativeSemiring'737'_2970
  = C_IsCommutativeSemiring'737''46'constructor_43689 MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_736
                                                      MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_736
                                                      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                                      (AgdaAny -> AgdaAny)
...
d_'43''45'isCommutativeMonoid_2988 v0
  = case coe v0 of
      C_IsCommutativeSemiring'737''46'constructor_43689 v1 v2 v3 v4
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Structures.Biased.IsCommutativeSemiringˡ.*-isCommutativeMonoid
...
data T_IsCommutativeSemiring'691'_3098
  = C_IsCommutativeSemiring'691''46'constructor_48737 MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_736
                                                      MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_736
                                                      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                                      (AgdaAny -> AgdaAny)
...
d_'43''45'isCommutativeMonoid_3116 v0
  = case coe v0 of
      C_IsCommutativeSemiring'691''46'constructor_48737 v1 v2 v3 v4
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Structures.Biased.IsCommutativeSemiringʳ.*-isCommutativeMonoid
...
data T_IsRing'42'_3228
  = C_IsRing'42''46'constructor_53849 MAlonzo.Code.Algebra.Structures.T_IsAbelianGroup_1132
                                      MAlonzo.Code.Algebra.Structures.T_IsMonoid_686
                                      MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                      MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_'43''45'isAbelianGroup_3248 v0
  = case coe v0 of
      C_IsRing'42''46'constructor_53849 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_'42''45'isMonoid_3250 v0
  = case coe v0 of
      C_IsRing'42''46'constructor_53849 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_distrib_3252 v0
  = case coe v0 of
      C_IsRing'42''46'constructor_53849 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_zero_3254 v0
  = case coe v0 of
      C_IsRing'42''46'constructor_53849 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsRingWithoutAnnihilatingZero_3308
  = C_IsRingWithoutAnnihilatingZero'46'constructor_56445 MAlonzo.Code.Algebra.Structures.T_IsAbelianGroup_1132
                                                         MAlonzo.Code.Algebra.Structures.T_IsMonoid_686
                                                         MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_'43''45'isAbelianGroup_3326 v0
  = case coe v0 of
      C_IsRingWithoutAnnihilatingZero'46'constructor_56445 v1 v2 v3
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
