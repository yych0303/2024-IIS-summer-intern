...
data T_MeetSemilattice_88
  = C_MeetSemilattice'46'constructor_1381 (AgdaAny ->
                                           AgdaAny -> AgdaAny)
                                          MAlonzo.Code.Algebra.Structures.T_IsCommutativeBand_590
...
d__'8743'__106 v0
  = case coe v0 of
      C_MeetSemilattice'46'constructor_1381 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isMeetSemilattice_108 v0
  = case coe v0 of
      C_MeetSemilattice'46'constructor_1381 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_JoinSemilattice_160
  = C_JoinSemilattice'46'constructor_2507 (AgdaAny ->
                                           AgdaAny -> AgdaAny)
                                          MAlonzo.Code.Algebra.Structures.T_IsCommutativeBand_590
...
d__'8744'__178 v0
  = case coe v0 of
      C_JoinSemilattice'46'constructor_2507 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isJoinSemilattice_180 v0
  = case coe v0 of
      C_JoinSemilattice'46'constructor_2507 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_BoundedSemilattice_232
  = C_BoundedSemilattice'46'constructor_3667 (AgdaAny ->
                                              AgdaAny -> AgdaAny)
                                             AgdaAny
...
d__'8729'__252 v0
  = case coe v0 of
      C_BoundedSemilattice'46'constructor_3667 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Lattice.Bundles.BoundedSemilattice.ε
d_ε_254 :: T_BoundedSemilattice_232 -> AgdaAny
d_ε_254 v0
  = case coe v0 of
      C_BoundedSemilattice'46'constructor_3667 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isBoundedSemilattice_256 v0
  = case coe v0 of
      C_BoundedSemilattice'46'constructor_3667 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_BoundedMeetSemilattice_328
  = C_BoundedMeetSemilattice'46'constructor_5115 (AgdaAny ->
                                                  AgdaAny -> AgdaAny)
                                                 AgdaAny
                                                 MAlonzo.Code.Algebra.Structures.T_IsIdempotentCommutativeMonoid_852
...
d__'8743'__348 v0
  = case coe v0 of
      C_BoundedMeetSemilattice'46'constructor_5115 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Lattice.Bundles.BoundedMeetSemilattice.⊤
d_'8868'_350 :: T_BoundedMeetSemilattice_328 -> AgdaAny
d_'8868'_350 v0
  = case coe v0 of
      C_BoundedMeetSemilattice'46'constructor_5115 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isBoundedMeetSemilattice_352 v0
  = case coe v0 of
      C_BoundedMeetSemilattice'46'constructor_5115 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_boundedSemilattice_396 v0
  = coe
      C_BoundedSemilattice'46'constructor_3667 (d__'8743'__348 (coe v0))
...
data T_BoundedJoinSemilattice_414
  = C_BoundedJoinSemilattice'46'constructor_6455 (AgdaAny ->
                                                  AgdaAny -> AgdaAny)
                                                 AgdaAny
                                                 MAlonzo.Code.Algebra.Structures.T_IsIdempotentCommutativeMonoid_852
...
d__'8744'__434 v0
  = case coe v0 of
      C_BoundedJoinSemilattice'46'constructor_6455 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Lattice.Bundles.BoundedJoinSemilattice.⊥
d_'8869'_436 :: T_BoundedJoinSemilattice_414 -> AgdaAny
d_'8869'_436 v0
  = case coe v0 of
      C_BoundedJoinSemilattice'46'constructor_6455 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isBoundedJoinSemilattice_438 v0
  = case coe v0 of
      C_BoundedJoinSemilattice'46'constructor_6455 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_boundedSemilattice_482 v0
  = coe
      C_BoundedSemilattice'46'constructor_3667 (d__'8744'__434 (coe v0))
...
d_Lattice_500 a0 a1 = ()
data T_Lattice_500
  = C_Lattice'46'constructor_7829 (AgdaAny -> AgdaAny -> AgdaAny)
...
d__'8744'__520 v0
  = case coe v0 of
      C_Lattice'46'constructor_7829 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Lattice.Bundles.Lattice._∧_
d__'8743'__522 :: T_Lattice_500 -> AgdaAny -> AgdaAny -> AgdaAny
d__'8743'__522 v0
  = case coe v0 of
      C_Lattice'46'constructor_7829 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isLattice_524 v0
  = case coe v0 of
      C_Lattice'46'constructor_7829 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_DistributiveLattice_584
  = C_DistributiveLattice'46'constructor_9399 (AgdaAny ->
                                               AgdaAny -> AgdaAny)
                                              (AgdaAny -> AgdaAny -> AgdaAny)
...
d__'8744'__604 v0
  = case coe v0 of
      C_DistributiveLattice'46'constructor_9399 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Lattice.Bundles.DistributiveLattice._∧_
d__'8743'__606 ::
  T_DistributiveLattice_584 -> AgdaAny -> AgdaAny -> AgdaAny
d__'8743'__606 v0
  = case coe v0 of
      C_DistributiveLattice'46'constructor_9399 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isDistributiveLattice_608 v0
  = case coe v0 of
      C_DistributiveLattice'46'constructor_9399 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_lattice_664 v0
  = coe
      C_Lattice'46'constructor_7829 (d__'8744'__604 (coe v0))
...
data T_BooleanAlgebra_682
  = C_BooleanAlgebra'46'constructor_11373 (AgdaAny ->
                                           AgdaAny -> AgdaAny)
                                          (AgdaAny -> AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny)
                                          AgdaAny AgdaAny
...
d__'8744'__708 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_11373 v3 v4 v5 v6 v7 v8 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Lattice.Bundles.BooleanAlgebra._∧_
d__'8743'__710 ::
  T_BooleanAlgebra_682 -> AgdaAny -> AgdaAny -> AgdaAny
d__'8743'__710 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_11373 v3 v4 v5 v6 v7 v8 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Lattice.Bundles.BooleanAlgebra.¬_
d_'172'__712 :: T_BooleanAlgebra_682 -> AgdaAny -> AgdaAny
d_'172'__712 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_11373 v3 v4 v5 v6 v7 v8 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Lattice.Bundles.BooleanAlgebra.⊤
d_'8868'_714 :: T_BooleanAlgebra_682 -> AgdaAny
d_'8868'_714 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_11373 v3 v4 v5 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Lattice.Bundles.BooleanAlgebra.⊥
d_'8869'_716 :: T_BooleanAlgebra_682 -> AgdaAny
d_'8869'_716 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_11373 v3 v4 v5 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isBooleanAlgebra_718 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_11373 v3 v4 v5 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_distributiveLattice_790 v0
  = coe
      C_DistributiveLattice'46'constructor_9399 (d__'8744'__708 (coe v0))
